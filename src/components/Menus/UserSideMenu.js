    ...
    <div className="absolute top-12 right-8 py-4 px-6 rounded-lg shadow-xl" style={{ background: theme.sideMenuBg }}>
      ...
      <div style={{ borderBottom: `1px solid ${theme.border}` }}>
        <ul style={{ color: theme.menuText }}>
          <li className="custom-hover" style={{ "--hover-bg": theme.sideMenuHover}}>
          ...
          <li className="custom-hover" style={{ "--hover-bg": theme.sideMenuHover}} onClick={handleSignOut}>
      ...
      <div style={{ borderBottom: `1px solid ${theme.border}` }}>
        <ul style={{ color: theme.menuText }}>
          ...
          <li className="custom-hover" style={{ "--hover-bg": theme.sideMenuHover}} onClick={handleAppearanceMenu}>
      ...
      <div style={{ borderBottom: `1px solid ${theme.border}` }}>
        <ul style={{ color: theme.menuText }}>
          <li className="flex custom-hover" style={{ "--hover-bg": theme.sideMenuHover}}>
